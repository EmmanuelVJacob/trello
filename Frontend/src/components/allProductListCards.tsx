  ...
  return (
    <>
      <div className="container mx-auto py-20">
        <h2 className="font-bold text-3xl ml-1 mr-auto text-black px-4">{`All Products`}</h2>

        <div className="grid grid-cols-1 auto-cols-max gap-x-4 lg:grid-cols-3 w-full mt-5 px-4">
          {cards.length > 0 ? (
            cards.map((item: any) => {
              return (
